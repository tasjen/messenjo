...
export interface TokenVerifierClient extends grpc.Client {
...
export interface TokenVerifierHandlers extends grpc.UntypedServiceImplementation {
  VerifyToken: grpc.handleUnaryCall<_AuthRequest__Output, _AuthResponse>;
  
}

export interface TokenVerifierDefinition extends grpc.ServiceDefinition {
