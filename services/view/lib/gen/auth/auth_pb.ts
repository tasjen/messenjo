...
// @generated from file auth/auth.proto (syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message VerifyTokenReq
 */
export class VerifyTokenReq extends Message<VerifyTokenReq> {
  ...
  static readonly typeName = "VerifyTokenReq";
...
/**
 * @generated from message VerifyTokenRes
 */
export class VerifyTokenRes extends Message<VerifyTokenRes> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "VerifyTokenRes";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
